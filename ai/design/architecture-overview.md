...
- `ai/adr/ADR-0001-target-tenant.md` through `ai/adr/ADR-0008-publish-pipeline-integration.md` (all decisions restated here)
- `ai/research/SPIKE-06-pipeline-integration.md` (as-is pipeline mechanics, object storage key layout, hotlink behavior)
- `ai/research/SPIKE-02-voice-model.md` (voice access pattern, SSML and endpoint shapes)
