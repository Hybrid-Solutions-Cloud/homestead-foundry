...
- `ai/adr/ADR-0002-image-model-and-access.md` (version pinning, 2026-09-01, canvas cap, tier ladder, retirement facts)
- `ai/adr/ADR-0003-voice-model-and-voice-set.md` (preview risk, listen-only v1, spike gates, fallback voice family)
- `ai/adr/ADR-0004-foundry-topology-and-region.md` (two-resource isolation, S0 200 TPS, custom subdomain, GA re-verify)
- `ai/adr/ADR-0006-cost-governance.md` (three-layer enforcement, budget mechanics and latency, ledger reconciliation, credit watch)
- `ai/adr/ADR-0001-target-tenant.md` (fallback pre-checks, eastus2 blocker, spending-limit mechanics)
- `ai/adr/ADR-0008-publish-pipeline-integration.md` (pre-render invariants, manifest-last, hashes, reconciliation-first)
- `ai/research/SPIKE-01-image-model.md` and `ai/research/SPIKE-02-voice-model.md` (429 behavior, sub-minute enforcement, quotas: 10-minute cap, 64 KB SSML, S0 TPS)
