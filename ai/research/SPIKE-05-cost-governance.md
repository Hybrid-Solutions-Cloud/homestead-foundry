...
- Sibling spike (image token mechanics, rate-card caveat and 19.50 USD Flash conflict, tokens-per-image method, canvas, RPM ladder, 2e retirement): `ai/research/SPIKE-01-image-model.md`
