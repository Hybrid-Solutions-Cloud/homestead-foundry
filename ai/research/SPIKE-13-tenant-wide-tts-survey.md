...
Depends on: `ai/research/SPIKE-03-tenant-readiness.md` (established subscription and tenant inventory), `ai/verification/environment-readiness.md` (existing Cognitive Services accounts per subscription), `ai/research/SPIKE-02-voice-model.md` (MAI-Voice-2 access pattern and region facts), `ai/adr/ADR-0004-foundry-topology-and-region.md` (single-shared-resource topology this spike tests for fragmentation risk)
Companion: `ai/research/SPIKE-07-speech-models.md` (the vendor and open/self-host comparison this spike deliberately does not duplicate)
...
- Established inventory (this repo): `ai/research/SPIKE-03-tenant-readiness.md`, `ai/verification/environment-readiness.md`
- Topology decision this spike tests for fragmentation (this repo): `ai/adr/ADR-0004-foundry-topology-and-region.md`, `ai/adr/ADR-0006-cost-governance.md`, `ai/adr/ADR-0005-identity-and-secrets.md`, `ai/adr/ADR-0007-content-safety-and-responsible-ai.md`
- Voice-model facts reused, not re-derived (this repo): `ai/research/SPIKE-02-voice-model.md`
- Companion vendor/self-host survey, deliberately not duplicated (this repo): `ai/research/SPIKE-07-speech-models.md`
