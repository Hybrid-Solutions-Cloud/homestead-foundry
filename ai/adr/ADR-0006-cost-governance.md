...
- `ai/research/SPIKE-05-cost-governance.md` (cost rollup; budget-is-notify-only fact; pipeline hard stop; tag scheme; EA-only credit alerts)
- `ai/research/SPIKE-03-tenant-readiness.md` (MVP monthly credit mechanics; spending limit auto-disable; three-guard strategy)
