...
- `ai/research/SPIKE-01-image-model.md` (model family and lifecycle, cost mechanics, style-matching capabilities, canvas math, rate-limit ladder, RAI and provenance)
