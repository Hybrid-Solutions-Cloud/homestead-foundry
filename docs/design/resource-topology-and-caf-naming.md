...
- `docs/adr/ADR-0001-target-tenant.md` (subscription, tenant, region, eastus2 blocker)
- `docs/adr/ADR-0004-foundry-topology-and-region.md` (kind, SKU, deployment shape, custom subdomain, naming intent deferred to design)
- `docs/adr/ADR-0006-cost-governance.md` (budget scope, amount, thresholds, action group, tag scheme, tag limits)
- `docs/adr/ADR-0005-identity-and-secrets.md` (Key Vault reuse, secret names, names-only rule)
