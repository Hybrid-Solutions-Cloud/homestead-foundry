...
(`docs/research/SPIKE-02-voice-model.md`) verified availability, the prebuilt
...
- `docs/research/SPIKE-02-voice-model.md` (availability, prebuilt voice and style tables, WordBoundary risk, tier, pricing, SSML style controls)
