...
This decision covers any Azure AI Foundry build in this repo that generates scene art and synthetic narration for a children's or brand-sensitive `<brand>` catalog: MAI-Image-2.5 scene art with children present in scenes (ADR-0002) and MAI-Voice-2 synthetic narration (ADR-0003). SPIKE-04 (`docs/research/SPIKE-04-identity-security.md`) and SPIKE-01 (`docs/research/SPIKE-01-image-model.md`) ground the responsible-AI posture in first-party Microsoft sources.
