...
`docs/research/SPIKE-03-tenant-readiness.md`, `docs/research/SPIKE-04-identity-security.md`,
and `docs/research/SPIKE-06-pipeline-integration.md`:
...
- `docs/research/SPIKE-03-tenant-readiness.md` (region and tier confirmation; the qualifying region satisfies both models)
- `docs/research/SPIKE-04-identity-security.md` (custom subdomain; Global Standard residency; no deploy step for voice)
- `docs/research/SPIKE-06-pipeline-integration.md` (two-resource key split; narrator stays on the existing resource; canvas sizes and endpoints)
