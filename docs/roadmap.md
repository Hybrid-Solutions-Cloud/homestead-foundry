...
- **The research and decision record.** Twenty-one research spikes in `docs/research/` and seventeen ADRs in `docs/adr/` covering model selection, topology, identity, cost governance, content safety, pipeline integration, observability, multi-target deployment automation, and agent tool governance.
