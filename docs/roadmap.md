...
- **The research and decision record.** Nineteen research spikes in `docs/research/` and fourteen ADRs in `docs/adr/` covering model selection, topology, identity, cost governance, content safety, pipeline integration, multi-target deployment automation, and agent tool governance.
