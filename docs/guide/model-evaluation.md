...
[SPIKE-33](../research/SPIKE-33-code-document-model-comparison). Its candidate
...
Claude Sonnet 5 appears in SPIKE-33 as an informational price and capability
...
Using the Global Standard rates measured in SPIKE-33 and ignoring cache discounts
...
This estimate is valid only for the dated rates in SPIKE-33. Re-read the current
