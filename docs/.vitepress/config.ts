  ...
  },
  {
    ...
    items: [
      ...
      { text: "Content safety", link: "/guide/content-safety" },
              { text: "Model gateway", link: "/guide/model-gateway" },
              { text: "Model Router and MCP roles", link: "/guide/model-router" },
      { text: "Model behaviour and limits", link: "/guide/model-behaviour-and-limits" },
    ...
    nav: [
      {
        ...
        items: [
          ...
          { text: "Cost and quality review", link: "/research/model-selection-2026-09-25" },
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Current cloud roster", link: "/reference/cloud-model-roster-2026-09-25" },
          ...
          { text: "Available: Azure Local Foundry", link: "/reference/model-availability-azure-local-foundry" },
      ...
      "/reference/": [
        ...
        },
        {
          ...
          items: [
            ...
            { text: "Foundry Local", link: "/reference/model-availability-foundry-local" },
            { text: "Azure Local Foundry", link: "/reference/model-availability-azure-local-foundry" },
          ],
        },
      ],
      // Grouped by subject rather than listed by number. Thirty spikes in
      // one flat list is unscannable: nobody reads SPIKE-01 through SPIKE-35
      ...
      "/research/": [
        ...
        },
        {
          ...
          items: [
            ...
            { text: "SPIKE-35 Code/document model comparison", link: "/research/SPIKE-35-code-document-model-comparison" },
