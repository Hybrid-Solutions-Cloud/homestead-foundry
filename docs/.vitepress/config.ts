      ...
      "/research/": [
        {
          ...
          items: [
            ...
            { text: "SPIKE-25 Local hardware sizing", link: "/research/SPIKE-25-local-track-hardware-sizing" },
            { text: "SPIKE-26 Local cost model", link: "/research/SPIKE-26-local-track-cost-model" },
            { text: "SPIKE-27 Local observability", link: "/research/SPIKE-27-local-track-observability" },
            { text: "SPIKE-28 Azure Local networking, TLS, storage", link: "/research/SPIKE-28-azure-local-networking-storage-certificates" },
            { text: "SPIKE-29 Local lifecycle and upgrade", link: "/research/SPIKE-29-local-track-lifecycle-and-upgrade" },
            { text: "SPIKE-31 Cross-track feature parity", link: "/research/SPIKE-31-cross-track-feature-parity" },
          ],
        },
      ],
      "/implementation/": [
