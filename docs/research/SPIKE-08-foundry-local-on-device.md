...
Grounding documents read first: the model roster (current and planned model roster), `docs/research/SPIKE-01-image-model.md`, and `docs/research/SPIKE-02-voice-model.md`. This spike does not restate the cloud plans; it evaluates a distinct runtime.
...
- Local, this repo: the model roster (roster: MAI-Image-2.5, FLUX.2-pro, FLUX.1-Kontext-pro, FLUX-1.1-pro, MAI-Voice-2, gpt-5.6-terra, grok-4-1-fast-reasoning, Sora); `docs/research/SPIKE-01-image-model.md`; `docs/research/SPIKE-02-voice-model.md`
