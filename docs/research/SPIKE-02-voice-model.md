...
- Companion infrastructure check in this workspace (AIServices S0 offerable in East US; MAI-Voice-2 confirmed for East US via docs, not the model catalog; existing legacy TTS account is F0 SpeechServices, wrong kind): [../verification/environment-readiness.md](https://github.com/Hybrid-Solutions-Cloud/homestead-foundry/blob/main/ai/verification/environment-readiness.md)
