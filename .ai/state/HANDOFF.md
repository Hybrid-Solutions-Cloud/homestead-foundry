...
The private overlay pins each reviewed release. Removed the completed-migration status table and its heading from the operational dashboard; remaining panel IDs, queries and compact layout are preserved.
